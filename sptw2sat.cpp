...
//	unsigned long long int vv,vu;
    ...
    char c;
    if (argc < 3) {
        printf("wrong input\n to run type ./hybw2sat bw output_file depth(optional)<input_file\n");
        exit(0);
    }//*/
...
//            for (u = 1; u <= nv; u++)                                      //initialization of blocks
////            {
////                for (v = u + 1; v <= nv; v++) {
////                    // fprintf(file,"-%llu 0\n",block[u][v][0]);
////                    //  fprintf(file,"%-llu 0\n",block[u][v][nsteps]);
...
//                nclauses += 1;
//            }
//            for (i = 0; i <= nsteps; i++)                                //transitivity
//            {
//                for (u = 1; u <= nv; u++) {
//                    for (v = u + 1; v <= nv; v++) {
//                        for (w = v + 1; w <= nv; w++) {
...
//                }
//            }
//            for (i = 0; i < nsteps; i++)                  //~block(u,u,i)->~block(u,u,i+1)
//            {
//                for (u = 1; u <= nv; u++) {
//                    //fprintf(file,"%llu -%llu 0\n",block[u][u][i],block[u][u][i+1]);
//                    nclauses++;
...
//                for (u = 1; u <= nv; u++) {
//                    for (w = u + 1; w <= nv; w++) {
//                        //      fprintf(file,"-%llu %llu 0\n",block[u][w][i],block[u][u][i]);
//                        nclauses++;
//                    }
//                }
//            }
//            for (i = 0; i < nsteps; i++)                                   //~block(u,v,i+1)=>~block(u,v,i)
//            {
//                for (u = 1; u <= nv; u++) {
//                    for (v = u + 1; v <= nv; v++) {
//                        //  fprintf(file,"%llu -%llu 0\n",block[u][v][i+1],block[u][v][i]);
//                        nclauses++;
//                        //   nclauses++;
//                    }
//                }
//            }
//#ifdef led_ver
//            for(i=0;i<=nsteps;i++)								//leader clauses
//            {
//                for(v=1;v<=nv;v++)
//                {
//                    for(u=1;u<v;u++)
...
//                }
//            }
//            for(i=0;i<=nsteps;i++)								//only one edge is leader and it is the first edge in lexicographical order
//            {
//                for(v=1;v<=nv;v++)
//                {
//                   // for(u=1;u<v;u++)
...
//#endif // led_ver
//            for (i = 0; i <
//                        nsteps; i++)                                                                    //~block(u,u,i) | block (u,u,i+1) | ~block(v,v,i) | block(u,v,i) | block(v,v,i+1)
//            {
//                for (u = 1; u <= nv; u++) {
//                    for (v = u + 1; v <= nv; v++) {
//                        if (has_edge(u, v)) {
//                            //fprintf(file,"-%llu -%llu %llu %llu 0\n",block[u][u][i],block[v][v][i],block[u][u][i+1],block[u][v][i]);
//                            //fprintf(file,"-%llu -%llu %llu %llu 0\n",block[u][u][i],block[v][v][i],block[v][v][i+1],block[u][v][i]);
//                            //cout<<u<<v<<endl;
//                            nclauses += 2;
//                        }
//                    }
...
//                    for (u = 1; u <= nv; u++) {
//                        for (v = u; v < nv; v++) {
//                            for (j = 1; j <= min(bw, v); j++) {
//                                //fprintf(file,"-%llu %llu 0\n",ctr[u][v][j][i],ctr[u][v+1][j][i]);
//                                nclauses++;
//                            }
//                        }
//                        for (v = u; v <= nv; v++) {
//                            // fprintf(file,"-%llu -%llu %llu 0\n",led[u][i],block[u][v][i],ctr[u][v][1][i]);
//                            nclauses++;
//                        }
//                        for (v = u + 1; v <= nv; v++) {
//                            for (j = 2; j <= min(bw, v); j++) {
//                                //fprintf(file,"-%llu -%llu -%llu %llu 0\n",led[u][i],block[u][v][i],ctr[u][v-1][j-1][i],ctr[u][v][j][i]);
//                                nclauses++;
//                            }
//                        }
//                        for (v = u + 1; v <= nv; v++) {
//                            for (j = bw + 1; j < nv; j++) {
//                                //fprintf(file,"-%llu -%llu -%llu 0\n",led[u][i],block[u][v][i],ctr[u][v-1][bw][i]);
//                                nclauses++;
//                            }
//                        }
//                    }
...
//                for (u = 1; u <= nv; u++) {
//                    for (v = u + 1; v <= nv; v++) {
//                        fprintf(file, "%llu -%llu -%llu -%llu 0\n", block[u][v][i + 1], block[u][u][i + 1],
//                                block[v][v][i + 1], block[u][v][i]);
//                        // fprintf(file,"-%llu -%llu -%llu %llu 0\n",block[u][v][i],block[u][u][i+1],block[v][v][i+1],block[u][v][i+1]);
//                        nclauses++;
//                        //nclauses++;
//                    }
//                }
...
//#endif // led_ver
//            for (i = 0; i <
//                        nsteps; i++)                                          //(block(u,u,i) & ~block(u,u,i+1) &block(v,v,i)|((block(u,u,i) & block(v,v,i) & ~block(v,v,i+1))->block(u,v,i))
//                //~block(u,u,i) | block (u,u,i+1) | ~block(v,v,i) | block(u,v,i) | block(v,v,i+1)
//            {
//                for (u = 1; u <= nv; u++) {
//                    for (v = u + 1; v <= nv; v++) {
//                        if (has_edge(u, v)) {
